    ...
    return(
        <div className="container">
            <div className="image"> 
                ...
                <h4><i>25.00 €</i></h4>
                            <a onClick={() => props.addToBasket('catsTshirt')} className="addToCart cart1" href="#">Add to chart</a>                
                ...
                <h4><i>15.00 €</i></h4>
<a   onClick={() => props.addToBasket('newspaperTshirt')} className="addToCart cart2" href="#">Add to chart</a>                
                ...
                <h4><i>33.00 €</i></h4>
<a  onClick={() => props.addToBasket('infinityTshirt')}  className="addToCart cart3" href="#">Add to chart</a>                
                ...
                <h3>Abs shirt</h3>
                <h4><i>20.00 €</i></h4>
<a  onClick={() => props.addToBasket('absTshirt')}  className="addToCart cart4" href="#">Add to chart</a>                
